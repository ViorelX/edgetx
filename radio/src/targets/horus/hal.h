...
#define GPS_RCC_AHB1Periph            RCC_AHB1Periph_GPIOC
#define GPS_RCC_APB1Periph            RCC_APB1Periph_UART4
#define GPS_RCC_APB2Periph            0
#define GPS_USART                     UART4
#define GPS_GPIO_AF                   GPIO_AF_UART4
...
#define GPS_TX_GPIO_PIN               GPIO_Pin_10 // PC.10
#define GPS_RX_GPIO_PIN               GPIO_Pin_11 // PC.11
#define GPS_TX_GPIO_PinSource         GPIO_PinSource10
#define GPS_RX_GPIO_PinSource         GPIO_PinSource11
#elif !defined(INTERNAL_GPS)
  #define GPS_RCC_AHB1Periph            0
  #define GPS_RCC_APB1Periph            0
  #define GPS_RCC_APB2Periph            0
